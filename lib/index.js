...
Fs.prototype.resolveConflicts = function(base, head) {
    ...
    .then(function (conflicts) {
        ...
        // Commit resolved tree as a merge commit (two parents)
...
Fs.prototype.handleCannotFastForward = function (base, head, err) {
    ...
    if (err.code === errors.CODE.NOT_FAST_FORWARD) {
        // Quick fix: Remove leading 'heads/' so that GitHub recognizes base
        var fixedBase = refsUtils.unspecifyLocal(base);
        // Merge head into remote
        return this.driver.mergeBranches(head, fixedBase)
