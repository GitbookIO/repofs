...
Fs.prototype.create = function create(p, content, opts) {
    ...
    .then(function(exists) {
        ...
        return that.setChange(p, 'create', opts.message, content);
    })
    .then(function() {
...
Fs.prototype.unlink = function unlink(p, opts) {
    ...
    return this.setChange(p, 'remove', opts.message)
    .then(function() {
...
Fs.prototype.setChange = function(filePath, type, msg, buffer) {
    ...
    return Q(this.pendingCommit[ref])
    .then(function() {
        return that.fetchTree(ref);
    })
    .then(function(tree) {
...
Fs.prototype.checkout = function(branchName, opts) {
    ...
    .then(function() {
        if (_.isString(branchName)) return that.getBranch(branch);
        return branchName;
    })
    .then(function(branch) {
