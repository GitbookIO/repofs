...
Fs.prototype.commit = function(opts) {
    ...
    this.pendingCommit = this.fetchWorkingTree()
        ...
        .fail(this.handleCannotFastForward.bind(this, branch, newCommit.sha))
...
Fs.prototype.push = function(opts) {
    ...
    var remoteBranch = opts.remote.name+'/'+opts.branch;
    ...
    .thenResolve({})
    .fail(function (err) {
        return that.handleCannotFastForward(remoteBranch, that.working.head())
...
Fs.prototype.pull = function(opts) {
    ...
    .fail(this.handleCannotFastForward.bind(this, opts.branch, remoteBranch))
...
Fs.prototype._bindFile = function(file, opts) {
    ...
    file.id = [file.path, this.working.head().sha, file.sha || 'working'].join('-');
