...
Fs.prototype.commit = function(opts) {
    ...
    this.pendingCommit = this.fetchWorkingTree()
        ...
        .fail(this.handleCannotFastForward.bind(this, refLocal, newCommit.sha))
...
Fs.prototype.push = function(opts) {
    ...
    .thenResolve({})
    .fail(function (err) {
        return that.handleCannotFastForward(refRemote, refLocal)
...
Fs.prototype.pull = function(opts) {
    ...
    .fail(this.handleCannotFastForward.bind(this, refLocal, refRemote))
