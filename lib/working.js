...
// Return true if has a checkout branch
WorkingTree.prototype.isCheckout = function() {
    return Boolean(this.currentBranch);
};
...
WorkingTree.prototype.revertChanges = function(type) {
    ...
    _.each(_.keys(tree.changes), function(filePath) {
        ...
        this._revertChange(filePath);
    }, this);
};

// Get current commit message
WorkingTree.prototype.getCommitMessage = function() {
...
// Update tree in cache
WorkingTree.prototype.set = function setCacheTree(tree) {
    this.setCache('tree.'+this.currentBranch, tree);
};

// Remove tree from cache
WorkingTree.prototype.destroy = function removeCacheTree() {
    this.delCache('tree.'+this.currentBranch);
};

// Load tree in cache
WorkingTree.prototype.get = function getCacheTree() {
