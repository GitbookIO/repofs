...
// Normalize file infos
Driver.prototype._mapStat = function (p, stats) {
    return {
        name: path.basename(p),
        path: this.relative(p),
...
Driver.prototype.stat = function(p, opts) {
    ...
    return this.queue(function() {
        ...
        .then(_.bind(that._mapStat, that, p));
    }, {
        ref: opts.ref
    });
};
...
Driver.prototype.write = function(p, content, opts) {
    ...
    return this.queue(function() {
        ...
        .then(function() {
            ...
            // Commit changes
            return that.repo.commit({
                message: opts.message,
                files: [p],
                name: that.options.commiter.name,
                email: that.options.commiter.email
            });
        });
    }, {
        ref: opts.ref
