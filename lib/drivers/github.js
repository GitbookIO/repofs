...
Driver.prototype.mapFile = function(ref, infos) {
    return {
        "name": infos.name,
        "path": infos.path,
        "content": infos.content? arrayBuffer.fromBase64(infos.content.replace(/(\r\n|\n|\r)/gm,"")) : undefined,
        "sha": infos.sha,
        "type": infos.type,
        "size": infos.size,
        "url": infos.download_url || url.resolve(this.options.rawhost, this.options.repository+'/'+ref+'/'+infos.path)
    };
}
...
Driver.prototype.write = function(p, content, opts) {
    ...
    .then(function(result) {
        ...
        return that.mapFile(opts.ref, result);
    });
};
