...
/**
 * Normalize a commit coming from the GitHub API
 * @param {JSON} ghCommit
 * @return {Commit}
 */
function normCommit(ghCommit) {
    return Commit.create({
        sha: ghCommit.sha,
        message: ghCommit.commit.message,
        author: getAuthor(ghCommit),
        committer: ghCommit.committer,
...
function getAuthor(ghCommit) {
    return Author.create(
        ghCommit.commit.author.name,
        ghCommit.commit.author.email,
        new Date(ghCommit.commit.author.date),
        ghCommit.author? ghCommit.author.avatar_url : undefined
    );
}
