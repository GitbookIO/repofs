...
// Returns an object map of the paths from both trees, with conflict info
// {
//   <path1>: {
...
// null
function listConflicts(baseTree, headTree) {
    var conflicts = {};
    ...
    _.forEach(baseTree, _.partial(storeSha, 'base'));
    _.forEach(headTree, _.partial(storeSha, 'head'));
